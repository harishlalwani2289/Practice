...
public class PrizeExcel {
    ...
    public static List<harish.ticketgen.Prize> getAllPrizes() {
        XSSFSheet sheet = workbook.getSheet("Prizes");
        List<harish.ticketgen.Prize> prizeList = new ArrayList<>();

        int rowNum = 2;

        do {

            harish.ticketgen.Prize prize = new harish.ticketgen.Prize();
