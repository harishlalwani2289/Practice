...
import practice.harish.ticketgen.model.Prize;
...
class App extends JFrame implements ActionListener{
 ...
 List<practice.harish.ticketgen.Ticket> ticketsWon;
 ...
 public void addElements(){
  ...
  practice.harish.ticketgen.ExcelNumberHighlight.highlightThePickedNumber(random_number[pos]+1);
 ...
 private void printtheTheTicketsWhichHasWon(List<Integer> calledNumbers, List<practice.harish.ticketgen.Prize> prizeList) {
  ticketsWon = practice.harish.ticketgen.GameWinner.getWinningTickets(calledNumbers, prizeList);
  if(ticketsWon.size() > 0) {

   for(practice.harish.ticketgen.Ticket ticket : ticketsWon) {
